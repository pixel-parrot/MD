...
# create nexus
nexus = create_object(room.Room, key = 'The Nexus', aliases = ['Nexus','nexus','The nexus','the Nexus','the nexus'], location = None)
...
#
arena = create_object(room.Room, key = 'The Arena', aliases = ['Arena'], location = None)
...
arena_to_nexus = create_object(exit.Exit, key = 'Nexus', aliases = ['the nexus'], location = arena, destination = nexus)
arena_to_nexus.tags.add('exit')
nexus_to_arena = create_object(exit.Exit, key = 'Arena', aliases = ['the arena'], location = nexus, destination = arena)
...
#
void = create_object(room.Room, key = 'The Void', aliases = ['void'], location = None)
...
#
#
market1 = create_object(room.Room, key = 'The Market', aliases = ['market'], location = None)
...
#
arena = search_object('arena')[0]
arena_to_market = create_object(exit.Exit, key = 'east', aliases = ['the market', 'market'], location = arena, destination = market1)
arena_to_market.tags.add('exit')
#
market_to_arena = create_object(exit.Exit, key = 'west', aliases = ['the arena', 'arena'], location = market1, destination = arena)
...
arena = search_object('Arena')[0]
#
frito = create_object(character.Character, key = "Frito", location = nexus, home = nexus)
...
#
camacho = create_object(character.Character, key = "Camacho", location = nexus, home = nexus)
...
#
aragorn = create_object(character.Character, key = 'Aragorn', location = nexus, home = nexus)
...
#
gandalf = create_object(character.Character, key = 'Gandalf', location = nexus, home = nexus)
...
#
#
rock = create_object(stackable_object.StackableObject, key = 'rock', location = nexus, home = nexus)
rock.db.object_title = 'a fucking rock, m8'
rock.db.description = "wtf do you expect, it's a goddamn rock you witty little cunt"
#
rock2 = create_object(stackable_object.StackableObject, key = 'rock', location = nexus, home = nexus)
...
#
rock3 = create_object(stackable_object.StackableObject, key = 'rock', location = nexus, home = nexus)
rock3.db.object_title = 'rockier than ever'
rock3.db.description = "rock you like a hurricane"
#
rock4 = create_object(stackable_object.StackableObject, key = 'rock', location = nexus, home = nexus)
rock4.db.object_title = 'such rock'
rock4.db.description = "wow"
#
rock5 = create_object(stackable_object.StackableObject, key = 'rock', location = nexus, home = nexus)
...
pillory1.db.object_title = 'a crude wooden restraint'
...
caller.cmdset.add('cmdset.PlayerCmdSet')
